function [stateTrajectory, t, steeringUsed] = fcn_VD_kinematicBicycleModelRK4(initialStates, deltaT, timeInterval, steeringAndTimeInputs, U, varargin)
...
for ith_time = 1:N_timeSteps
	...
	[~, y] = fcn_VD_RungeKutta(...
		@(t,y) fcn_VD_derivativesKinematicBicycleModel(y,inputOmega, U, -1), ...
